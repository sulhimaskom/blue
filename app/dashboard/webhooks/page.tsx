...
export default function WebhookMonitoringPage() {
  ...
  const handleManualRefresh = () => {
    setLoading(true);
    // The WebhookQueueMonitor will handle the refresh
  };
      ...
      <div className="max-w-7xl mx-auto space-y-6">
        ...
        <div className="mb-8">
          <DashboardHeader
            ...
            description="Real-time monitoring and management of webhook processing queues"
          />
        ...
        <div className="space-y-8">
          {/* Webhook Queue Monitor Component */}
          <WebhookQueueMonitor
            ...
            <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
              ...
              <div className="space-y-2 text-sm text-gray-600">
                ...
                <div className="flex items-start gap-2">
                  <div className="w-2 h-2 bg-blue-500 rounded-full mt-1.5"></div>
                  <span>
                    Periodically retry dead letter events for transient failures
                  </span>
                </div>
              </div>
            </div>
