          ...
          <div className="space-y-2">
            {filteredItems.map((item) => (
              <Link
                ...
                href={item.href}
                className={cn(
                  "block px-4 py-2 rounded-lg text-sm font-medium transition-all duration-200 hover:scale-105",
                  item.active
            ...
            <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3">
              {filteredItems.map((item, index) => (
                <Link
                  ...
                  role="menuitem"
                  className={cn(
                    "block px-3 py-2 rounded-md text-base font-medium transition-all duration-200 hover:scale-105 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2",
                    item.active
                      ? "bg-blue-50 text-blue-700"
