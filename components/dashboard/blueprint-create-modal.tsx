        ...
        <div className="bg-white rounded-lg max-w-2xl w-full max-h-[90vh] overflow-y-auto">
          ...
          <form onSubmit={onSubmit} className="p-6">
                ...
                <div className="flex">
                  ...
                  <div className="text-sm text-blue-800">
                    ...
                    <p>
                      ...
                      account. You currently have {credits} credits available.
                      Your form is validated in real-time to help create better
                      blueprints.
                    </p>
                    {!canSubmit && (
                      <p className="mt-2 text-yellow-700">
                        Complete all required fields and fix validation errors
                        to submit.
                      </p>
                    )}
                  </div>
            ...
            <div className="mt-6 flex justify-end space-x-3">
              ...
              <Button type="submit" disabled={credits < 1 || !canSubmit}>
