    ...
    <div className="space-y-2">
      ...
      <div className="flex items-center gap-2">
        ...
        <input
          ...
          disabled={disabled}
          className={cn(
            "flex-1 px-3 py-2 border rounded-md focus:outline-none focus:ring-2 focus:ring-offset-0 transition-colors duration-200 hover:border-gray-400 font-mono text-sm",
            error
        ...
        <input
          ...
          disabled={disabled}
          className={cn(
            "w-10 h-10 border border-gray-300 rounded cursor-pointer flex-shrink-0 transition-all duration-200 hover:scale-105 hover:border-gray-400",
            disabled && "opacity-50 cursor-not-allowed",
          )}
