...
describe("Real-time Blueprint Validation - Issue #114", () => {
  beforeEach(() => {
    mockFetch.mockClear();
  ...
  test("should show character count for blueprint description field", async () => {
    ...
    const descriptionField = screen.getByLabelText("Blueprint Description *");
    ...
    expect(screen.getByText(/36.*1000 characters/)).toBeInTheDocument();
  });
