...
// Mock environment validation to bypass test requirements - MUST be at top level for Jest hoisting
...
jest.mock('@/lib/env', () => ({
  env: {
    ...
    get IFLOW_API_KEY() {
      return process.env.IFLOW_API_KEY || 'test-iflow-key';
    },
    get TAVILY_API_KEY() {
      return process.env.TAVILY_API_KEY || 'test-tavily-key';
    },
    get NEXT_PUBLIC_CLERK_PUBLISHABLE_KEY() {
      return process.env.NEXT_PUBLIC_CLERK_PUBLISHABLE_KEY || 'test-clerk-publishable';
    },
    get CLERK_SECRET_KEY() {
      return process.env.CLERK_SECRET_KEY || 'test-clerk-secret';
    },
    get CLERK_WEBHOOK_SECRET() {
      return process.env.CLERK_WEBHOOK_SECRET || 'test-clerk-webhook-secret';
    },
    get STRIPE_SECRET_KEY() {
      return process.env.STRIPE_SECRET_KEY || 'test-stripe-secret';
    },
    get NEXT_PUBLIC_STRIPE_PUBLISHABLE_KEY() {
      return process.env.NEXT_PUBLIC_STRIPE_PUBLISHABLE_KEY || 'test-stripe-publishable';
    },
    get STRIPE_WEBHOOK_SECRET() {
      return process.env.STRIPE_WEBHOOK_SECRET || 'whsec_test_webhook_secret';
    },
    get STRIPE_WEBHOOK_SECRETS_ADDITIONAL() {
      return process.env.STRIPE_WEBHOOK_SECRETS_ADDITIONAL;
    },
    get GITHUB_ACCESS_TOKEN() {
      return process.env.GITHUB_ACCESS_TOKEN || 'test-github-token';
    },
    get GITHUB_APP_ID() {
      return process.env.GITHUB_APP_ID || 'test-app-id';
    },
    get GITHUB_APP_PRIVATE_KEY() {
      return process.env.GITHUB_APP_PRIVATE_KEY || 'test-private-key';
    },
    get REDIS_URL() {
...
// Mock constants with actual test-safe values - MUST be at top level for Jest hoisting
